...
echo -e "gene_id\t${name1}_${geno}\t${name2}_${geno}\t${name3}_${geno}\t${name1}_Q\t${name2}_Q\t${name3}_Q" > header.txt
...
echo -e "gene_id\t${name4}_${geno}\t${name5}_${geno}\t${name6}_${geno}\t${name4}_Q\t${name5}_Q\t${name6}_Q" > header.txt
